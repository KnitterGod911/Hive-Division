...
export const beesByRarity = {
  ...
  event: [
    ...
    bee('Cobalt Bee', 'blue', '2/21/CobaltFace.png/revision/latest?cb=20230507162258', 'A blue event bee that creates blue Pulse tokens and boosts blue pollen.'),
    bee('Crimson Bee', 'red', '7/7c/CrimsonFace.png/revision/latest?cb=20230507162259', 'A red event bee that creates red Pulse tokens and boosts red pollen.'),
    bee('Digital Bee', 'colorless', '6/6d/Digital_Bee_Face.png/revision/latest?cb=20230410011415', 'Copies enemy abilities and creates Code Mark tokens to amplify gathering.'),
    ...
    bee('Gummy Bee', 'colorless', 'f/f4/GummyBee.png/revision/latest?cb=20181223214121', 'Creates Goo and Goo puddles that collect pollen from nearby flowers.'),
    bee('Photon Bee', 'colorless', '6/62/PhotonFace.png/revision/latest?cb=20230423011134', 'Fires a beam that gathers pollen and creates Beamstorm tokens.'),
    ...
    bee('Tabby Bee', 'colorless', '5/5a/TabbyIcon.png/revision/latest?cb=20230507170206', 'Builds Tabby Love stacks to improve pollen and critical gathering.'),
    bee('Vicious Bee', 'colorless', 'a/a3/ViciousFace.png/revision/latest?cb=20230507162259', 'Creates impaling spikes and provides exceptional attack against enemies.'),
